    ...
    const events = [
        {
            ...
            description: "Join us for a joyful Christmas celebration filled with worship, music, and fellowship.",
            image: EventImage,
        },
        {
            day: "Monday",
            name: "New Year Celebration",
            description: "Celebrate the New Year with a night of praise, thanksgiving, and reflection.",
            image: EventImage,
        },
        {
            day: "Friday",
            name: "Kesha Night",
            description: "Spend Friday night in prayer, worship, and renewal during our special Kesha.",
            image: EventImage,
        },
    ];
